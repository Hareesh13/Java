...
public class EncryptMain extends JApplet implements ActionListener
{
	JButton b1,b2,b3;
	JFrame f;
EncryptMain()
{
	...
	b1=new JButton("Encrypt Message");
	b2=new JButton("Encrypt File");
	b3=new JButton("Exit");
	...
	if(s.equals("Encrypt Message"))
	{
		new EncryptMessage().setVisible(true);
		f.setVisible(false);
		//f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	}
	else if(s.equals("Encrypt File"))
	{
